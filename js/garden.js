// Vector class for handling 2D vectors
function Vector(x, y) {
    this.x = x;
    this.y = y;
}
...
// Petal class for individual flower petals
function Petal(stretchA, stretchB, startAngle, angle, growFactor, bloom) {
    ...
    // Commented out tangent angle calculations
...
// Garden class for managing the flower garden
